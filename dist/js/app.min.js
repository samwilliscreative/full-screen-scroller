...
var fssInit = function fssInit(userOptions) {
  ...
  var navOpenState = false; // If the user doesn't pass a height value, get the height of the element manually
  ...
  fssOptions.inner.show(); // Add inactive class to the body. This can be used for styling etc.
